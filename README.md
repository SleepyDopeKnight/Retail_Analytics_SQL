...
2. [Chapter II](#chapter-ii) \
   2.1. [Part 1. Creating a database](#part-1-creating-a-database)  
   2.2. [Part 2. Creating views](#part-2-creating-views)  
   2.3. [Part 3. Role model](#part-3-role-model)  
   2.4. [Part 4. Forming personal offers aimed at the growth of the average check](#part-4-forming-personal-offers-aimed-at-the-growth-of-the-average-check)  
   2.5. [Part 5. Forming personal offers aimed at increasing the frequency of visits](#part-5-forming-personal-offers-aimed-at-increasing-the-frequency-of-visits)  
   2.6. [Part 6. Forming personal offers aimed at cross-selling](#part-6-forming-personal-offers-aimed-at-cross-selling)
...
Write a *Database_creation_part1.sql* script that creates the database and tables described above in the [Input data](#input-data).
...
Create a **_part2.sql* script and write the views described above in the [Output data](#output-data). Also add test queries for each view.

You can find more information for each field in the materials.

## Part 3. Role model

Create roles in the *Role_model_creation.sql* script and give them permissions as described below.
...
Create a *Offers_on_average_check_part4.sql* script, in which you should add the following function.
...
Create a *Offers_on_frequency_of_visits_part5.sql* script and add the following function to it.
...
Create a *Offers_on_cross-selling_part6.sql* script and add the following function to it.
